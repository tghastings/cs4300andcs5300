...
\begin{enumerate}
    ...
    \item Each group member should take ownership of \textbf{at least one task}.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Follow the \textbf{Red-Red-Green-Green-Refactor} process. You don't need to worry about refactoring yet (end of semester).
...
\begin{itemize}
    ...
    \item \textbf{All} students should be pushing to GitHub. Make sure your name is associated with your GitHub pushes (For help: \url{https://help.github.com/articles/setting-your-username-in-git/}) so that you are not penalized for not contributing
...
Show your point assignments, ``employee'' assignments, and progress.

\subsection*{On Discord}
One team member must post to your Dev\_Cust Group on Discord with information about what was implemented and your application's URL. Customers will see and can write posts to/from their developers.
