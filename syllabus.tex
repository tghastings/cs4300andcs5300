...
\begin{center}
{\LARGE \textbf{CS 4300/ CS 5300: Advanced Software Engineering}}\\[0.5em]
{\large Fall 2026}
\end{center}
...
\textbf{Time/Place:} 4:45pm to 6:00pm Tues/Thurs, ENGR 103
...
\textbf{Use Discord for MOST questions!} -- faster answers, extra feedback, easier code viewing, and all learn from each other as you hit new SE issues/challenges.

Please limit emails. If you do need to email for something personal, include your course number(s) in the subject line.

\textbf{On Discord, you must display your real name on our server.}

Groups will be set up on Discord for easier communication within and between teams. If you have a personal question, DM me and the TA (if appicable).

\textbf{Discord:} 
\href{https://discord.gg/aRHqvkXNH7}{Join Link} (Use your real name and upload a professional photo of yourself)
...
\begin{itemize}
    \item \textbf{DevEdu} -- We will go over this in class for how to get access. This has been purchased for you through VitalSource if you opt into TAAP. If you have opted out of TAAP you can purchase directly through the application (\$99) or you can self host with the open-source project: \url{https://github.com/DevEdu-IO/docker-django/blob/master/README.md}
\end{itemize}

\begin{itemize}
    \item \textbf{Kritik} -- We will go over this in class for how to get access. This has been purchased for you through VitalSource if you opt into TAAP. If you have opted out of TAAP you can purchase directly through the application (\$20).
\end{itemize}

\section*{Course Texts}

\begin{itemize}
    \item \textbf{Software Engineering: Standing on the Shoulders of Giants}, First Beta Edition. Hastings.\\
    \url{https://www.swebook.org/} (Required)\\
    \textit{Note: The PDF of the book is free on the website! Print/Kindle Version is available through the site as well. Make sure to download the Python version.}
...
\textbf{Use Discord for class-related questions!} If you have questions about course tools, assignments, coding issues, etc., post to Discord in the appropriate channel. If something is of personal nature, DM me (and/or) the TA. If emailing, put CS4300 or CS5300 in your email subject line \textbf{always}. Otherwise, I am \textbf{very likely} to miss it.

The TA and teacher will be checking Discord daily, but do not wait until the last minute to ask questions -- it is very likely that we will not see your posts \textbf{and} be able to get back to you. We will be checking every 24 hours. In your questions, be as specific as possible so we can help quickly.
