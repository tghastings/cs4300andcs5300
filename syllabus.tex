...
\textbf{Instructor:} Dr.\ Tom Hastings

\textbf{Time/Place:} 4:45pm to 6:00pm Tues/Thurs, OCSE B216
...
\textbf{Slack Link:} \url{https://join.slack.com/t/cs4300cs5300sp25/shared_invite/zt-3npo7thsh-GboDVgEt1~2pKyCB0_Jq6Q}
...
\begin{itemize}
    ...
    \url{http://www.saasbook.info/} (Optional)\\
    ...
    \item \textbf{Software Engineering Body of Knowledge (SWEBOK)}. Available for download from \url{http://www.swebok.org/}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item 7\% (CS5300)
    \end{itemize}
    \item \textbf{Homeworks (2):} 6\%
    \item \textbf{Tests (2):} 30\%
