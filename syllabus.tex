...
\begin{itemize}
    \item \textbf{Software Engineering: Standing on the Shoulders of Giants}, First Beta Edition.\\
    \url{https://www.swebook.org/} (Required)\\
    \textit{Note: The PDF and epub of the book are free on the website. We will be using the Python version.}
