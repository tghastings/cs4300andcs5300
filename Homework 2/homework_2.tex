...
\begin{enumerate}
    \item Submit a zip file using Canvas containing: \begin{itemize}
        ...
        \item README file with setup instructions and the Render URL.
...
Documentation &
5 &
- README file is complete, explaining project structure, setup, how to run the application, and the Render URL.\\
& &
