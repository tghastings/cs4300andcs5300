...
\lstset{
    basicstyle=\ttfamily\color{blue}, % Keeps your preferred global look
}

\newlist{todolist}{itemize}{2}
\setlist[todolist]{label=$\square$}

\title{Homework 1: Introduction to Python \& Unit Testing (Revised)}
\author{}
\date{}
...
\end{center}
    ...
    \item Clone the new \textit{cs4300} git repository to \textit{/coursework}/:
    \begin{itemize}
    \item Complete the following objectives: \begin{todolist}
    ...
    \end{todolist}
    \end{itemize}
    \item Inside of the newly cloned directory \textit{(/coursework/cs4300)} create two directories: homework1 and homework2. 
\end{todolist}
\end{itemize}
...
Create a new file named \verb|task1.py|. Write a Python script that prints \verb|"Hello, World!"| on the console. Set up a pytest test case that verifies the output of your script capturing stdout. - \href{https://docs.pytest.org/en/stable/getting-started.html}{Docs}. 

\subsection{Task 2: Variables and Data Types}
Create a new file named \verb|task2.py| demonstrating the use of various data types, including integers, floating-point numbers, strings, and boolean. Implement pytest to test case for each data type, ensuring that the script's behavior matches the expected outcomes.
...
\subsection{Task 6: File Handling}
...
\subsection{Task 7: Package Management}
